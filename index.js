...
(function() {
  ...
  Phaser.Plugin.AdvancedTiming = (function(superClass) {
    ...
    AdvancedTiming.modes = [AdvancedTiming.MODE_DEFAULT, AdvancedTiming.MODE_GRAPH, AdvancedTiming.MODE_METER, AdvancedTiming.MODE_TEXT];
    ...
    AdvancedTiming.prototype.updateText = function() {
      var fps;
      fps = this.game.time.fps;
      this.text.text = fps + " fps " + this.renderType;
